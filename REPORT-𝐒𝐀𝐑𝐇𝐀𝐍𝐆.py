                 ...
                 :gBgi     BQBBBBBBBQBBBBBBBBB     rMBZ.
                    idBBgrJBBBBBBBBBBBBBBBBBBB77QBBP:
                        .rv1XZMQQBBBBBBBQQgZSu7i
                                  bay""")
print(Fore.RED)
print("id Rubika target ro ward kon in payen bedon @ --")
id = input()
os.system("clear")
print(Fore.GREEN)
print(F"ok attack sroh shod be @{id} filter Rubika.ir")
#!/usr/bin/python
